# -*- coding: utf-8 -*-
"""
Created on Sat Aug  1 14:35:15 2020
@author: user
"""
...
Domain['Security'].append('Network')
Domain['Coding'].append('Architecture')
...
#The preference function  is required to give output Domain(s) and Event(s).
